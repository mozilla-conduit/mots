...
def anchor_people_for_module(i, person, key, file_config, directory, module):
...
def clean(file_config: FileConfig, write: bool = True):
    ...
    for i, module in enumerate(file_config.config["modules"]):
        ...
        for emeritus_key in emeritus_keys:
            if "meta" in module and module["meta"] and module["meta"].get(emeritus_key):
            ...
            for submodule in module["submodules"]:
                ...
                for emeritus_key in emeritus_keys:
                    if (
                        "meta" in submodule
                        and submodule["meta"]
                        and submodule["meta"].get(emeritus_key)
                    ):
